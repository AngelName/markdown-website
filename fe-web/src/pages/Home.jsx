...
function SectionPage() {
    return <SinglePage style={{minHeight:'100vh'}}>
        <Row >
            <ColLayout >
...
function ThreePage() {
    return <SinglePage style={{minHeight:'100vh',paddingBottom:'80px'}}>
        <Row >
            <ColLayout >
                <section style={{margin:'20vh 0 0 0'}}>
                    <p>自适应样式</p>
...
function SinglePage({children,...otherProps}){
    return <div className={'home-page'} style={{minHeight:'calc(100vh - 80px)'}} {...otherProps}>
        {children}
    </div>
}
function Home(props) {
